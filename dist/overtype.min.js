...
`,r),s=e.slice(a,n),l=s.match(/^(#{1,3})\s/);if(l)if(l[1].length===t){let p=s.replace(/^#{1,3}\s/,"");this.textarea.setRangeText(p,a,n,"end")}else{let p=s.replace(/^#{1,3}/,"#".repeat(t));this.textarea.setRangeText(p,a,n,"end")}else{let p="#".repeat(t)+" "+s;this.textarea.setRangeText(p,a,n,"end")}this.editor.updatePreview()}destroy(){this.shortcuts.clear()}};var f={name:"solar",colors:{bgPrimary:"#faf0ca",bgSecondary:"#ffffff",text:"#0d3b66",h1:"#f95738",h2:"#ee964b",h3:"#3d8a51",strong:"#ee964b",em:"#f95738",link:"#0d3b66",code:"#0d3b66",codeBg:"rgba(244, 211, 94, 0.2)",blockquote:"#5a7a9b",hr:"#5a7a9b",syntaxMarker:"rgba(13, 59, 102, 0.52)",cursor:"#f95738",selection:"rgba(244, 211, 94, 0.4)",listMarker:"#ee964b"}},b={name:"cave",colors:{bgPrimary:"#141E26",bgSecondary:"#1D2D3E",text:"#c5dde8",h1:"#d4a5ff",h2:"#f6ae2d",h3:"#9fcfec",strong:"#f6ae2d",em:"#9fcfec",link:"#9fcfec",code:"#c5dde8",codeBg:"#1a232b",blockquote:"#9fcfec",hr:"#c5dde8",syntaxMarker:"rgba(159, 207, 236, 0.73)",cursor:"#f26419",selection:"rgba(51, 101, 138, 0.4)",listMarker:"#f6ae2d"}},k={solar:f,cave:b,light:f,dark:b};function y(i){return typeof i=="string"?{...k[i]||k.solar,name:i}:i}function S(i){let t=[];for(let[e,r]of Object.entries(i)){let a=e.replace(/([A-Z])/g,"-$1").toLowerCase();t.push(`--${a}: ${r};`)}return t.join(`
`)}function w(i,t={}){return{...i,colors:{...i.colors,...t}}}function L(i={}){let{fontSize:t="14px",lineHeight:e=1.6,fontFamily:r="'SF Mono', Monaco, 'Cascadia Code', 'Roboto Mono', Consolas, 'Courier New', monospace",padding:a="20px",theme:n=null,mobile:s={}}=i,l=Object.keys(s).length>0?`
  ...
  `:"",p=n&&n.colors?S(n.colors):"";return`
    ...
    ${l}
  `}var o=class o{constructor(t,e={}){let r;if(typeof t=="string"){if(r=document.querySelectorAll(t),r.length===0)throw new Error(`No elements found for selector: ${t}`);r=Array.from(r)}else if(t instanceof Element)r=[t];else if(t instanceof NodeList)r=Array.from(t);else if(Array.isArray(t))r=t;else throw new Error("Invalid target: must be selector string, Element, NodeList, or Array");return r.map(n=>{if(n.overTypeInstance)return n.overTypeInstance.reinit(e),n.overTypeInstance;let s=Object.create(o.prototype);return s._init(n,e),n.overTypeInstance=s,o.instances.set(n,s),s})}_init(t,e={}){this.element=t,this.options=this._mergeOptions(e),this.instanceId=++o.instanceCount,this.initialized=!1,o.injectStyles(this.options),o.initGlobalListeners();let r=t.querySelector(".overtype-wrapper");r?this._recoverFromDOM(r):this._buildFromScratch(),this.shortcuts=new v(this),this.initialized=!0,this.options.onChange&&this.options.onChange(this.getValue(),this)}_mergeOptions(t){let e={fontSize:"14px",lineHeight:1.6,fontFamily:"'SF Mono', Monaco, 'Cascadia Code', 'Roboto Mono', Consolas, 'Courier New', monospace",padding:"16px",theme:"solar",mobile:{fontSize:"16px",padding:"12px",lineHeight:1.5},autofocus:!1,placeholder:"Start typing...",value:"",onChange:null,onKeydown:null,showActiveLineRaw:!1,showStats:!1,statsFormatter:null},r=t.theme||e.theme;return typeof r=="string"&&(r=y(r)),t.colors&&(r=w(r||f,t.colors)),{...e,...t,theme:r}}_recoverFromDOM(t){if(this.wrapper=t,this.textarea=t.querySelector(".overtype-input"),this.preview=t.querySelector(".overtype-preview"),!this.textarea||!this.preview){t.remove(),this._buildFromScratch();return}this.wrapper._instance=this,this._configureTextarea(),this._applyOptions()}_buildFromScratch(){let t=this._extractContent();this.element.innerHTML="",this._createDOM(),(t||this.options.value)&&this.setValue(t||this.options.value),this._applyOptions()}_extractContent(){let t=this.element.querySelector(".overtype-input");return t?t.value:this.element.textContent||""}_createDOM(){var e;this.wrapper=document.createElement("div"),this.wrapper.className="overtype-wrapper";let t=typeof this.options.theme=="string"?this.options.theme:(e=this.options.theme)==null?void 0:e.name;t&&this.wrapper.setAttribute("data-theme",t),this.options.showStats&&this.wrapper.classList.add("with-stats"),this.wrapper._instance=this,this.textarea=document.createElement("textarea"),this.textarea.className="overtype-input",this.textarea.placeholder=this.options.placeholder,this._configureTextarea(),this.preview=document.createElement("div"),this.preview.className="overtype-preview",this.preview.setAttribute("aria-hidden","true"),this.wrapper.appendChild(this.textarea),this.wrapper.appendChild(this.preview),this.options.showStats&&(this.statsBar=document.createElement("div"),this.statsBar.className="overtype-stats",this.wrapper.appendChild(this.statsBar),this._updateStats()),this.element.appendChild(this.wrapper)}_configureTextarea(){this.textarea.setAttribute("autocomplete","off"),this.textarea.setAttribute("autocorrect","off"),this.textarea.setAttribute("autocapitalize","off"),this.textarea.setAttribute("spellcheck","false"),this.textarea.setAttribute("data-gramm","false"),this.textarea.setAttribute("data-gramm_editor","false"),this.textarea.setAttribute("data-enable-grammarly","false")}_applyOptions(){this.options.autofocus&&this.textarea.focus(),this.updatePreview()}updatePreview(){let t=this.textarea.value,e=this.textarea.selectionStart,r=this._getCurrentLine(t,e),a=u.parse(t,r,this.options.showActiveLineRaw);this.preview.innerHTML=a||'<span style="color: #808080;">Start typing...</span>',this.options.showStats&&this.statsBar&&this._updateStats(),this.options.onChange&&this.initialized&&this.options.onChange(t,this)}_getCurrentLine(t,e){return t.substring(0,e).split(`
`).length-1}handleInput(t){this.updatePreview()}handleKeydown(t){!this.shortcuts.handleKeydown(t)&&this.options.onKeydown&&this.options.onKeydown(t,this)}handleScroll(t){this.preview.scrollTop=this.textarea.scrollTop,this.preview.scrollLeft=this.textarea.scrollLeft}getValue(){return this.textarea.value}setValue(t){this.textarea.value=t,this.updatePreview()}setTheme(t){this.options.theme=typeof t=="string"?y(t):t;let e=typeof t=="string"?t:t==null?void 0:t.name;e&&this.wrapper&&this.wrapper.setAttribute("data-theme",e),o.injectStyles(this.options,!0),this.updatePreview()}focus(){this.textarea.focus()}blur(){this.textarea.blur()}isInitialized(){return this.initialized}reinit(t={}){this.options=this._mergeOptions({...this.options,...t}),this._applyOptions(),this.updatePreview()}_updateStats(){if(!this.statsBar)return;let t=this.textarea.value,e=t.split(`
`),r=t.length,a=t.split(/\s+/).filter(c=>c.length>0).length,n=this.textarea.selectionStart,l=t.substring(0,n).split(`
`),p=l.length,h=l[l.length-1].length+1;this.options.statsFormatter?this.statsBar.innerHTML=this.options.statsFormatter({chars:r,words:a,lines:e.length,line:p,column:h}):this.statsBar.innerHTML=`
          <div class="overtype-stat">
            <span class="live-dot"></span>
            <span>${r} chars, ${a} words, ${e.length} lines</span>
          </div>
          <div class="overtype-stat">Line ${p}, Col ${h}</div>
        `}showStats(t){this.options.showStats=t,t&&!this.statsBar?(this.statsBar=document.createElement("div"),this.statsBar.className="overtype-stats",this.wrapper.appendChild(this.statsBar),this.wrapper.classList.add("with-stats"),this._updateStats()):!t&&this.statsBar&&(this.statsBar.remove(),this.statsBar=null,this.wrapper.classList.remove("with-stats"))}destroy(){if(this.element.overTypeInstance=null,o.instances.delete(this.element),this.shortcuts&&this.shortcuts.destroy(),this.wrapper){let t=this.getValue();this.wrapper.remove(),this.element.textContent=t}this.initialized=!1}static init(t,e={}){return new o(t,e)}static getInstance(t){return t.overTypeInstance||o.instances.get(t)||null}static destroyAll(){document.querySelectorAll("[data-overtype-instance]").forEach(e=>{let r=o.getInstance(e);r&&r.destroy()})}static injectStyles(t={},e=!1){if(o.stylesInjected&&!e)return;let r=document.querySelector("style.overtype-styles");r&&r.remove();let a=L(t),n=document.createElement("style");n.className="overtype-styles",n.textContent=a,document.head.appendChild(n),o.stylesInjected=!0}static initGlobalListeners(){o.globalListenersInitialized||(document.addEventListener("input",t=>{if(t.target.classList.contains("overtype-input")){let e=t.target.closest(".overtype-wrapper"),r=e==null?void 0:e._instance;r&&r.handleInput(t)}}),document.addEventListener("keydown",t=>{if(t.target.classList.contains("overtype-input")){let e=t.target.closest(".overtype-wrapper"),r=e==null?void 0:e._instance;r&&r.handleKeydown(t)}}),document.addEventListener("scroll",t=>{if(t.target.classList.contains("overtype-input")){let e=t.target.closest(".overtype-wrapper"),r=e==null?void 0:e._instance;r&&r.handleScroll(t)}},!0),document.addEventListener("selectionchange",t=>{let e=document.activeElement;if(e&&e.classList.contains("overtype-input")){let r=e.closest(".overtype-wrapper"),a=r==null?void 0:r._instance;a&&(a.options.showStats&&a.statsBar&&a._updateStats(),clearTimeout(a._selectionTimeout),a._selectionTimeout=setTimeout(()=>{a.updatePreview()},50))}}),o.globalListenersInitialized=!0)}};d(o,"instances",new WeakMap),d(o,"stylesInjected",!1),d(o,"globalListenersInitialized",!1),d(o,"instanceCount",0);var m=o;m.MarkdownParser=u;m.ShortcutsManager=v;m.themes={solar:f,cave:y("cave")};m.getTheme=y;m.mergeTheme=w;var E=m;return B(M);})();
/**
