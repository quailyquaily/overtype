...
`),t=0;for(let o=0;o<e.length;o++){let r=e[o].length+1;n.selectionStart>=t&&n.selectionStart<t+r&&(n.selectionStart=t),n.selectionEnd>=t&&n.selectionEnd<t+r&&(n.selectionEnd=t+r-1),t+=r}}function Te(n,e,t,o=!1){if(n.selectionStart===n.selectionEnd)n.selectionStart=Ae(n.value,n.selectionStart),n.selectionEnd=Be(n.value,n.selectionEnd,o);else{let r=n.selectionStart-e.length,i=n.selectionEnd+t.length,s=n.value.slice(r,n.selectionStart)===e,a=n.value.slice(n.selectionEnd,i)===t;s&&a&&(n.selectionStart=r,n.selectionEnd=i)}return n.value.slice(n.selectionStart,n.selectionEnd)}function q(n){let e=n.value.slice(0,n.selectionStart),t=n.value.slice(n.selectionEnd),o=e.match(/\n*$/),r=t.match(/^\n*/),i=o?o[0].length:0,s=r?r[0].length:0,a,c;return e.match(/\S/)&&i<2&&(a=Z(`
`,2-i)),t.match(/\S/)&&s<2&&(c=Z(`
`,2-s)),a==null&&(a=""),c==null&&(c=""),{newlinesToAppend:a,newlinesToPrepend:c}}var C=null;function Me(n,{text:e,selectionStart:t,selectionEnd:o}){let r=n.selectionStart,i=n.value.slice(0,r),s=n.value.slice(n.selectionEnd);if(C===null||C===!0){n.contentEditable="true";try{C=document.execCommand("insertText",!1,e)}catch(a){C=!1}n.contentEditable="false"}if(C&&!n.value.slice(0,n.selectionStart).endsWith(e)&&(C=!1),!C){try{document.execCommand("ms-beginUndoUnit")}catch(a){}n.value=i+e+s;try{document.execCommand("ms-endUndoUnit")}catch(a){}n.dispatchEvent(new CustomEvent("input",{bubbles:!0,cancelable:!0}))}t!=null&&o!=null?n.setSelectionRange(t,o):n.setSelectionRange(r,n.selectionEnd)}function _e(n,e){let t,o,{prefix:r,suffix:i,blockPrefix:s,blockSuffix:a,replaceNext:c,prefixSpace:y,scanFor:l,surroundWithNewlines:h}=e,f=n.selectionStart,b=n.selectionEnd,p=n.value.slice(n.selectionStart,n.selectionEnd),u=V(p)&&s.length>0?`${s}
`:r,v=V(p)&&a.length>0?`
${a}`:i;if(y){let g=n.value[n.selectionStart-1];n.selectionStart!==0&&g!=null&&!g.match(/\s/)&&(u=` ${u}`)}p=Te(n,u,v,e.multiline);let m=n.selectionStart,w=n.selectionEnd,me=c.length>0&&v.indexOf(c)>-1&&p.length>0;if(h){let g=q(n);t=g.newlinesToAppend,o=g.newlinesToPrepend,u=t+r,v+=o}if(p.startsWith(u)&&p.endsWith(v)){let g=p.slice(u.length,p.length-v.length);if(f===b){let k=f-u.length;k=Math.max(k,m),k=Math.min(k,m+g.length),m=w=k}else w=m+g.length;return{text:g,selectionStart:m,selectionEnd:w}}else if(me)if(l.length>0&&p.match(l)){v=v.replace(c,p);let g=u+p+v;return m=w=m+u.length,{text:g,selectionStart:m,selectionEnd:w}}else{let g=u+p+v;return m=m+u.length+p.length+v.indexOf(c),w=m+c.length,{text:g,selectionStart:m,selectionEnd:w}}else{let g=u+p+v;m=f+u.length,w=b+u.length;let k=p.match(/^\s*|\s*$/g);if(e.trimFirst&&k){let W=k[0]||"",R=k[1]||"";g=W+u+p.trim()+v+R,m+=W.length,w-=R.length}return{text:g,selectionStart:m,selectionEnd:w}}}function $e(n,e){let{prefix:t,suffix:o,surroundWithNewlines:r}=e,i=n.value.slice(n.selectionStart,n.selectionEnd),s=n.selectionStart,a=n.selectionEnd,c=i.split(`
...
`),r){let{newlinesToAppend:l,newlinesToPrepend:h}=q(n);s+=l.length,a=s+i.length,i=l+i+h}return{text:i,selectionStart:s,selectionEnd:a}}function U(n){let e=n.split(`
