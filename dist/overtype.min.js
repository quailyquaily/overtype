...
`.repeat(2-a)),{newlinesToAppend:s,newlinesToPrepend:l}}function _(n,e,t={}){let o=n.selectionStart,i=n.selectionEnd,r=o===i,a=n.value,s=o;for(;s>0&&a[s-1]!==`
`;)s--;if(r){let d=o;for(;d<a.length&&a[d]!==`
`;)d++;n.selectionStart=s,n.selectionEnd=d}else se(n);let l=e(n);if(t.adjustSelection){let c=n.value.slice(n.selectionStart,n.selectionEnd).startsWith(t.prefix),p=t.adjustSelection(c,o,i,s);l.selectionStart=p.start,l.selectionEnd=p.end}else if(t.prefix){let c=n.value.slice(n.selectionStart,n.selectionEnd).startsWith(t.prefix);r?c?(l.selectionStart=Math.max(o-t.prefix.length,s),l.selectionEnd=l.selectionStart):(l.selectionStart=o+t.prefix.length,l.selectionEnd=l.selectionStart):c?(l.selectionStart=Math.max(o-t.prefix.length,s),l.selectionEnd=Math.max(i-t.prefix.length,s)):(l.selectionStart=o+t.prefix.length,l.selectionEnd=i+t.prefix.length)}return l}function R(n,e){let t,o,{prefix:i,suffix:r,blockPrefix:a,blockSuffix:s,replaceNext:l,prefixSpace:d,scanFor:c,surroundWithNewlines:p,trimFirst:u}=e,h=n.selectionStart,m=n.selectionEnd,g=n.value.slice(n.selectionStart,n.selectionEnd),f=ne(g)&&a&&a.length>0?`${a}
`:i,w=ne(g)&&s&&s.length>0?`
${s}`:r;if(d){let x=n.value[n.selectionStart-1];n.selectionStart!==0&&x!=null&&!x.match(/\s/)&&(f=` ${f}`)}g=Ke(n,f,w,e.multiline);let y=n.selectionStart,k=n.selectionEnd,H=l&&l.length>0&&w.indexOf(l)>-1&&g.length>0;if(p){let x=J(n);t=x.newlinesToAppend,o=x.newlinesToPrepend,f=t+i,w+=o}if(g.startsWith(f)&&g.endsWith(w)){let x=g.slice(f.length,g.length-w.length);if(h===m){let C=h-f.length;C=Math.max(C,y),C=Math.min(C,y+x.length),y=k=C}else k=y+x.length;return{text:x,selectionStart:y,selectionEnd:k}}else if(H)if(c&&c.length>0&&g.match(c)){w=w.replace(l,g);let x=f+w;return y=k=y+f.length,{text:x,selectionStart:y,selectionEnd:k}}else{let x=f+g+w;return y=y+f.length+g.length+w.indexOf(l),k=y+l.length,{text:x,selectionStart:y,selectionEnd:k}}else{let x=f+g+w;y=h+f.length,k=m+f.length;let C=g.match(/^\s*|\s*$/g);if(u&&C){let G=C[0]||"",X=C[1]||"";x=G+f+g.trim()+w+X,y+=G.length,k-=X.length}return{text:x,selectionStart:y,selectionEnd:k}}}function ae(n,e){let{prefix:t,suffix:o,surroundWithNewlines:i}=e,r=n.value.slice(n.selectionStart,n.selectionEnd),a=n.selectionStart,s=n.selectionEnd,l=r.split(`
`);if(l.every(c=>c.startsWith(t)&&(!o||c.endsWith(o))))r=l.map(c=>{let p=c.slice(t.length);return o&&(p=p.slice(0,p.length-o.length)),p}).join(`
`),s=a+r.length;else if(r=l.map(c=>t+c+(o||"")).join(`
`),i){let{newlinesToAppend:c,newlinesToPrepend:p}=J(n);a+=c.length,s=a+r.length,r=c+r+p}return{text:r,selectionStart:a,selectionEnd:s}}function oe(n){let e=n.split(`
...
`).map((g,f)=>`${P(f,e.unorderedList)}${g}`),c=d.reduce((g,f,w)=>g+P(w,e.unorderedList).length,0),p=d.reduce((g,f,w)=>g+P(w,!e.unorderedList).length,0);if(a.processed)return t?(o=Math.max(o-P(0,e.unorderedList).length,0),i=o):(o=n.selectionStart,i=n.selectionEnd-c),{text:l,selectionStart:o,selectionEnd:i};let{newlinesToAppend:u,newlinesToPrepend:h}=J(n),m=u+d.join(`
`)+h;return t?(o=Math.max(o+P(0,e.unorderedList).length+u.length,0),i=o):s.processed?(o=Math.max(n.selectionStart+u.length,0),i=n.selectionEnd+u.length+c-p):(o=Math.max(n.selectionStart+u.length,0),i=n.selectionEnd+u.length+c),{text:m,selectionStart:o,selectionEnd:i}}function le(n,e){let t=_(n,o=>Je(o,e),{adjustSelection:(o,i,r,a)=>{let s=n.value.slice(a,n.selectionEnd),l=/^\d+\.\s+/,d=/^- /,c=l.test(s),p=d.test(s),u=e.orderedList&&c||e.unorderedList&&p;if(i===r)if(u){let h=s.match(e.orderedList?l:d),m=h?h[0].length:0;return{start:Math.max(i-m,a),end:Math.max(i-m,a)}}else if(c||p){let h=s.match(c?l:d),m=h?h[0].length:0,f=(e.unorderedList?2:3)-m;return{start:i+f,end:i+f}}else{let h=e.unorderedList?2:3;return{start:i+h,end:i+h}}else if(u){let h=s.match(e.orderedList?l:d),m=h?h[0].length:0;return{start:Math.max(i-m,a),end:Math.max(r-m,a)}}else if(c||p){let h=s.match(c?l:d),m=h?h[0].length:0,f=(e.unorderedList?2:3)-m;return{start:i+f,end:r+f}}else{let h=e.unorderedList?2:3;return{start:i+h,end:r+h}}}});M(n,t)}function Qe(n){if(!n)return[];let e=[],{selectionStart:t,selectionEnd:o,value:i}=n,r=i.split(`
`),a=0,s="";for(let p of r){if(t>=a&&t<=a+p.length){s=p;break}a+=p.length+1}s.startsWith("- ")&&(s.startsWith("- [ ] ")||s.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(s)&&e.push("numbered-list"),s.startsWith("> ")&&e.push("quote"),s.startsWith("# ")&&e.push("header"),s.startsWith("## ")&&e.push("header-2"),s.startsWith("### ")&&e.push("header-3");let l=Math.max(0,t-10),d=Math.min(i.length,o+10),c=i.slice(l,d);if(c.includes("**")){let p=i.slice(Math.max(0,t-100),t),u=i.slice(o,Math.min(i.length,o+100)),h=p.lastIndexOf("**"),m=u.indexOf("**");h!==-1&&m!==-1&&e.push("bold")}if(c.includes("_")){let p=i.slice(Math.max(0,t-100),t),u=i.slice(o,Math.min(i.length,o+100)),h=p.lastIndexOf("_"),m=u.indexOf("_");h!==-1&&m!==-1&&e.push("italic")}if(c.includes("`")){let p=i.slice(Math.max(0,t-100),t),u=i.slice(o,Math.min(i.length,o+100));p.includes("`")&&u.includes("`")&&e.push("code")}if(c.includes("[")&&c.includes("]")){let p=i.slice(Math.max(0,t-100),t),u=i.slice(o,Math.min(i.length,o+100)),h=p.lastIndexOf("["),m=u.indexOf("]");h!==-1&&m!==-1&&i.slice(o+m+1,o+m+10).startsWith("(")&&e.push("link")}return e}function V(n){if(!n||n.disabled||n.readOnly)return;v("toggleBold","Starting"),j(n,"Before");let e=T(L.bold),t=R(n,e);re(t),M(n,t),j(n,"After")}function D(n){if(!n||n.disabled||n.readOnly)return;let e=T(L.italic),t=R(n,e);M(n,t)}function ce(n){if(!n||n.disabled||n.readOnly)return;let e=T(L.code),t=R(n,e);M(n,t)}function q(n,e={}){if(!n||n.disabled||n.readOnly)return;let t=n.value.slice(n.selectionStart,n.selectionEnd),o=T(L.link);if(t&&t.match(/^https?:\/\//)&&!e.url?(o.suffix=`](${t})`,o.replaceNext=""):e.url&&(o.suffix=`](${e.url})`,o.replaceNext=""),e.text&&!t){let a=n.selectionStart;n.value=n.value.slice(0,a)+e.text+n.value.slice(a),n.selectionStart=a,n.selectionEnd=a+e.text.length}let r=R(n,o);M(n,r)}function W(n){if(!n||n.disabled||n.readOnly)return;let e=T(L.bulletList);le(n,e)}function U(n){if(!n||n.disabled||n.readOnly)return;let e=T(L.numberedList);le(n,e)}function pe(n){if(!n||n.disabled||n.readOnly)return;v("toggleQuote","Starting"),j(n,"Initial");let e=T(L.quote),t=_(n,o=>ae(o,e),{prefix:e.prefix});re(t),M(n,t),j(n,"Final")}function de(n){if(!n||n.disabled||n.readOnly)return;let e=T(L.taskList),t=_(n,o=>ae(o,e),{prefix:e.prefix});M(n,t)}function Q(n,e=1,t=!1){if(!n||n.disabled||n.readOnly)return;(e<1||e>6)&&(e=1),v("insertHeader","============ START ============"),v("insertHeader",`Level: ${e}, Toggle: ${t}`),v("insertHeader",`Initial cursor: ${n.selectionStart}-${n.selectionEnd}`);let o=`header${e===1?"1":e}`,i=T(L[o]||L.header1);v("insertHeader",`Style prefix: "${i.prefix}"`);let r=n.value,a=n.selectionStart,s=n.selectionEnd,l=a;for(;l>0&&r[l-1]!==`
`;)l--;let d=s;for(;d<r.length&&r[d]!==`
`;)d++;let c=r.slice(l,d);v("insertHeader",`Current line (before): "${c}"`);let p=c.match(/^(#{1,6})\s*/),u=p?p[1].length:0,h=p?p[0].length:0;v("insertHeader","Existing header check:"),v("insertHeader",`  - Match: ${p?`"${p[0]}"`:"none"}`),v("insertHeader",`  - Existing level: ${u}`),v("insertHeader",`  - Existing prefix length: ${h}`),v("insertHeader",`  - Target level: ${e}`);let m=t&&u===e;v("insertHeader",`Should toggle OFF: ${m} (toggle=${t}, existingLevel=${u}, level=${e})`);let g=_(n,f=>{let w=f.value.slice(f.selectionStart,f.selectionEnd);v("insertHeader",`Line in operation: "${w}"`);let y=w.replace(/^#{1,6}\s*/,"");v("insertHeader",`Cleaned line: "${y}"`);let k;return m?(v("insertHeader","ACTION: Toggling OFF - removing header"),k=y):u>0?(v("insertHeader",`ACTION: Replacing H${u} with H${e}`),k=i.prefix+y):(v("insertHeader","ACTION: Adding new header"),k=i.prefix+y),v("insertHeader",`New line: "${k}"`),{text:k,selectionStart:f.selectionStart,selectionEnd:f.selectionEnd}},{prefix:i.prefix,adjustSelection:(f,w,y,k)=>{if(v("insertHeader","Adjusting selection:"),v("insertHeader",`  - isRemoving param: ${f}`),v("insertHeader",`  - shouldToggleOff: ${m}`),v("insertHeader",`  - selStart: ${w}, selEnd: ${y}`),v("insertHeader",`  - lineStartPos: ${k}`),m){let H=Math.max(w-h,k);return v("insertHeader",`  - Removing header, adjusting by -${h}`),{start:H,end:w===y?H:Math.max(y-h,k)}}else if(h>0){let H=i.prefix.length-h;return v("insertHeader",`  - Replacing header, adjusting by ${H}`),{start:w+H,end:y+H}}else return v("insertHeader",`  - Adding header, adjusting by +${i.prefix.length}`),{start:w+i.prefix.length,end:y+i.prefix.length}}});v("insertHeader",`Final result: text="${g.text}", cursor=${g.selectionStart}-${g.selectionEnd}`),v("insertHeader","============ END ============"),M(n,g)}function he(n){Q(n,1,!0)}function ue(n){Q(n,2,!0)}function me(n){Q(n,3,!0)}function fe(n){return Qe(n)}var O=class{constructor(e){this.editor=e,this.textarea=e.textarea}handleKeydown(e){if(!(navigator.platform.toLowerCase().includes("mac")?e.metaKey:e.ctrlKey))return!1;let i=null;switch(e.key.toLowerCase()){case"b":e.shiftKey||(i="toggleBold");break;case"i":e.shiftKey||(i="toggleItalic");break;case"k":e.shiftKey||(i="insertLink");break;case"7":e.shiftKey&&(i="toggleNumberedList");break;case"8":e.shiftKey&&(i="toggleBulletList");break}return i?(e.preventDefault(),this.editor.toolbar?this.editor.toolbar.handleAction(i):this.handleAction(i),!0):!1}async handleAction(e){let t=this.textarea;if(t){t.focus();try{switch(e){case"toggleBold":V(t);break;case"toggleItalic":D(t);break;case"insertLink":q(t);break;case"toggleBulletList":W(t);break;case"toggleNumberedList":U(t);break}t.dispatchEvent(new Event("input",{bubbles:!0}))}catch(o){console.error("Error in markdown action:",o)}}}destroy(){}};var $={name:"solar",colors:{bgPrimary:"#faf0ca",bgSecondary:"#ffffff",text:"#0d3b66",h1:"#f95738",h2:"#ee964b",h3:"#3d8a51",strong:"#ee964b",em:"#f95738",link:"#0d3b66",code:"#0d3b66",codeBg:"rgba(244, 211, 94, 0.4)",blockquote:"#5a7a9b",hr:"#5a7a9b",syntaxMarker:"rgba(13, 59, 102, 0.52)",cursor:"#f95738",selection:"rgba(244, 211, 94, 0.4)",listMarker:"#ee964b",toolbarBg:"#ffffff",toolbarBorder:"rgba(13, 59, 102, 0.15)",toolbarIcon:"#0d3b66",toolbarHover:"#f5f5f5",toolbarActive:"#faf0ca"}},ve={name:"cave",colors:{bgPrimary:"#141E26",bgSecondary:"#1D2D3E",text:"#c5dde8",h1:"#d4a5ff",h2:"#f6ae2d",h3:"#9fcfec",strong:"#f6ae2d",em:"#9fcfec",link:"#9fcfec",code:"#c5dde8",codeBg:"#1a232b",blockquote:"#9fcfec",hr:"#c5dde8",syntaxMarker:"rgba(159, 207, 236, 0.73)",cursor:"#f26419",selection:"rgba(51, 101, 138, 0.4)",listMarker:"#f6ae2d",toolbarBg:"#1D2D3E",toolbarBorder:"rgba(197, 221, 232, 0.1)",toolbarIcon:"#c5dde8",toolbarHover:"#243546",toolbarActive:"#2a3f52"}},ye={solar:$,cave:ve,light:$,dark:ve};function I(n){return typeof n=="string"?{...ye[n]||ye.solar,name:n}:n}function z(n){let e=[];for(let[t,o]of Object.entries(n)){let i=t.replace(/([A-Z])/g,"-$1").toLowerCase();e.push(`--${i}: ${o};`)}return e.join(`
`)}function we(n,e={}){return{...n,colors:{...n.colors,...e}}}function be(n={}){let{fontSize:e="14px",lineHeight:t=1.6,fontFamily:o='"SF Mono", SFMono-Regular, Menlo, Monaco, "Cascadia Code", Consolas, "Roboto Mono", "Noto Sans Mono", "Droid Sans Mono", "Ubuntu Mono", "DejaVu Sans Mono", "Liberation Mono", "Courier New", Courier, monospace',padding:i="20px",theme:r=null,mobile:a={}}=n,s=Object.keys(a).length>0?`
    @media (max-width: 640px) {
      ...
      .overtype-wrapper .overtype-preview {
        ${Object.entries(a).map(([d,c])=>`${d.replace(/([A-Z])/g,"-$1").toLowerCase()}: ${c} !important;`).join(`
        `)}
      }
    }
  `:"",l=r&&r.colors?z(r.colors):"";return`
